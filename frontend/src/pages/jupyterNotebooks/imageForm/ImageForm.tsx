...
import * as mockImageList from '../mock_data/MockImages'
...
const ImageForm: React.FC<ImageFormProps> = ({ userConfig, onValidImage }) => {
  ...
  const imageList = mockImageList.mockImageList;
  ...
  React.useEffect(() => {
    ...
    // PLACEHOLDER UNTIL THE FUNCTIONALITY OF GETTING LAST IMAGE IS RESTORED
    const prevSelectedImageTag = getValuesFromImageName("s2i-generic-data-science-notebook:v0.0.4");
    ...
    if (currentImage && currentTag) {
      ...
      postChange("s2i-generic-data-science-notebook:v0.0.4");
      return;
    }
